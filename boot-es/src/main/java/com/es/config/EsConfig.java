 ...
 * Title: 配置
 *
 * Description: 有两种方式连接es 1:transportClient ES 7.0版本中将弃用TransportClient客户端，且在8.0版本中完全移除它
 *                            2:REST Client 这种方式是基于http 与 es 通信,方便(官网推荐),主要有restHighLevelClient 和restlowLevelClient俩版本
 * 这边使用low-restclient
 *
 * @author chenlm
...
//            }
//        });
        /* 4配置节点选择器，客户端以循环方式将每个请求发送到每一个配置的节点上，
